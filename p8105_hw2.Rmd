...
Total number of cigarette butts collected by Gwynnda in June 2022 is In June 2022, Gwynnda Trash Wheel collected `r gwynnda_df |>filter(year == 2022, month == "June") |>summarise(total_cigarette_butts = sum(cigarette_butts, na.rm = TRUE))|>pull(total_cigarette_butts)` cigarette butts.
...
* There are otal `r joined_zillow|> ncol()` observations. 
